<template>
    <!-- this component is to service the filepond upload -->
    <div id="documents" class="form-group">
        <div class="card mt-2">
            <div class="card-body">
                <div class="card-title">Documents to include</div>
                <!-- <div class="actions">
        ...
        methods: {
            ...
            submitFiles() {
                for( let i = 0; i < this.files.length; i++ ){
                    ...
                    this.$axios.post('/api/uploadFiles',
                        formData,
                        {
                            headers: {
                        ...
                        console.log('success');
                        this.flash('File Upload was a Success!','success');
                    }.bind(this)).catch(function(data) {
                        console.log('error');
                        this.flash('An error Occured during upload','warning');
                    });
                }
            }
        }
